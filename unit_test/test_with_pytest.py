...
def test_load_data_into_db():
    ...
    try:
        ...
        print(test_case_loaded_data.shape)
        print(loaded_data.shape)
    except Error as e:
        raise RuntimeError("Failure in testing load_data_into_db: " + str(e))
    finally:
        conn.close()
        conn_ut.close()
...
def test_map_city_tier():
    ...
    try:
        ...
        print("Reading data completed")
        print(test_case_city_tier.shape)
        print(city_tier_map.shape)
    except Error as e:
        raise RuntimeError("Failure in testing map_city_tier: " + str(e))
    finally:
        conn.close()
        conn_ut.close()
...
def test_map_categorical_vars():
    ...
    try:
        ...
        print(test_case_cat_var.shape)
        print(cat_var_map.shape)
    except Error as e:
        raise RuntimeError("Failure in testing map_categorical_vars: " + str(e))
    finally:
        conn.close()
        conn_ut.close()
...
def test_interactions_mapping():
    ...
    try:
        ...
        print(test_case_int_map.shape)
        print(int_map.shape)
    except Error as e:
        raise RuntimeError("Failure in testing interactions_mapping: " + str(e))
    finally:
        conn.close()
        conn_ut.close()
