...
DB_PATH = "/home/a/Assignment/01_data_pipeline/scripts/unit_test/"
DB_FILE_NAME = "utils_output.db"
UNIT_TEST_DB_FILE_NAME = 'unit_test_cases.db'
DATA_DIRECTORY = "/home/a/Assignment/01_data_pipeline/scripts/unit_test/"
...
INDEX_COLUMNS_INFERENCE = ['created_date', 'city_tier', 'first_platform_c',
                'first_utm_medium_c', 'first_utm_source_c', 'total_leads_droppped','referred_lead']
