...
def load_data_into_db():
    ...
    try:
        ...
        return "Data loaded in DB"
    except Error as e:
        raise RuntimeError("Failure in loading data into database: " + str(e))
    finally:
        connection.close()
...
def map_categorical_vars():
    ...
    try:
        ...
        new_df = df_lead_scoring[~df_lead_scoring['first_platform_c'].isin(list_platform)].copy()
        ...
        return "Categorical Variables mapped"
...
def interactions_mapping():
    ...
    try:
        ...
        return "Interactions mapping completed"
